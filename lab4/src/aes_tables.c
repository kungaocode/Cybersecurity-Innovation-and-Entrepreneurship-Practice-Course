/*
 * AES Experiment — Shared lookup tables (S-box, Inverse S-box, T-tables)
 */
...
/* ─── T-tables (Te = SubBytes + MixColumns combined) ─── */
...
/* Inverse T-tables (Td = InvSubBytes + InvMixColumns combined) */
